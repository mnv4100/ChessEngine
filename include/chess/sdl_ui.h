...
private:
    ...
    SDL_Texture* pieceTexture_{nullptr};
    bool running_{false};
    int windowWidth_{1000};
    int windowHeight_{1000};
    int spriteCellWidth_{0};
    int spriteCellHeight_{0};
    ...
    void loadAssets();
    void destroyAssets();
    void drawPieceSprite(PieceType type, Color color, SDL_FRect bounds);
    [[nodiscard]] SDL_FRect spriteSourceRect(PieceType type, Color color) const;
};
